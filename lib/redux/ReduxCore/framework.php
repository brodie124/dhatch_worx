...
//                $comparison = $field['required'][1];
        ...
        public function _enqueue_output() {
            ...
            if ( !is_admin() && !empty( $this->typography ) && !empty( $this->typography ) && filter_var( $this->args['output'], FILTER_VALIDATE_BOOLEAN ) ) {
        ...
        public function _download_options(){
            ...
            // XXX (default) $content = json_encode( $backup_options, true );
